    ...
    <div className="bg-black text-white p-4">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-6">
          <span to="/tutorials" className="hover:text-blue-400 transition-colors">Tutorials</span>
          <span to="/upload-notes" className="hover:text-blue-400 transition-colors">Upload Notes</span>
          <span to="/my-notes" className="hover:text-blue-400 transition-colors">My Notes</span>
      ...
      {isMenuOpen && (
        <div className="md:hidden mt-4 flex flex-col space-y-2">
          <span to="/tutorials" className="block py-2 hover:text-blue-400 transition-colors">Tutorials</span>
          <span to="/upload-notes" className="block py-2 hover:text-blue-400 transition-colors">Upload Notes</span>
          <span to="/my-notes" className="block py-2 hover:text-blue-400 transition-colors">My Notes</span>
